...
<head></head>
    ...
    <?php include './lib/header-script.php'; ?>
    <?php include './lib/footer-script.php'; ?>
<body>

<div class="container">
  <img src="<?php echo ASSET_URL; ?>images/Image.png" height="15%" style="position:absolute;"/><h2 style="position:absolute; left: 17%; top:0; font-family:calibri; font-size:300%;"> Rural Health and Nutrition Information System</h2>
