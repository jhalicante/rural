  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">
            <img style="   width: 50px;" src="Images/Image.png" alt="Logo Image"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="register1.php?mode=register">Register</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <header>
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        ?>
          <div class="carousel-item  bg-dark <?php echo $active; ?>" style="background-repeat: no-repeat; background-size: 1900px 1080px; background-image: url('<?php echo 'uploaded/'.$row['image1'].''.$row['image2'].''.$row['image3'].''.$row['image4'].''.$row['image5']; ?>')">
